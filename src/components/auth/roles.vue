  ...
  <div class="roles_container">
    ...
    <el-button @click="showAddDialog()" type="primary" plain>添加角色</el-button>
      <el-table :data="rolesList">
        ...
        <el-table-column property="authName" label="角色名称" prop="roleName"></el-table-column>
        <el-table-column property="path" label="角色描述" prop="roleDesc"></el-table-column>
...
<script>
import mixin from './rolesMixin.js'
export default {
  mixins: [mixin]
}
</script>
